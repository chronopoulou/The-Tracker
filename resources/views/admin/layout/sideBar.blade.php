    ...
    <div class="sidebar-inner">
        ...
        <div class="sidebar-logo">
            <div class="peers ai-c fxw-nw">
                <div class="peer peer-greed">
                    <a class="sidebar-link td-n" href="{{ route('websites.index')}}">
                        <div class="peers ai-c fxw-nw">
                            <div class="peer">
                                <div class="logo">
                                    <img src="/assets/static/images/logo.png" style="max-width: 47px; margin: 10px;" alt="">
                                </div>
                            </div>
                            <div class="peer peer-greed">
                                <h5 class="lh-1 mB-0 logo-text">The Tracker</h5>
                            </div>
                        </div>
                    </a>
                </div>
        ...
        <ul class="sidebar-menu scrollable pos-r">
          ...
          <li class="nav-item dropdown">
              <a class="dropdown-toggle" href="{{route('websites.index')}}">
